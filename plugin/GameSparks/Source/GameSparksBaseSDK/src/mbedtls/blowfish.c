...
// note: changed to extern, so that it compiles in C++ mode. (http://stackoverflow.com/a/936589)
extern const uint32_t S_blowfish[4][256];
...
const uint32_t S_blowfish[4][256] = {
