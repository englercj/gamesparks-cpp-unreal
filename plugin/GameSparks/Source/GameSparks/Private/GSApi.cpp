...
UGSMatchmakingRequest* UGSMatchmakingRequest::SendMatchmakingRequest(FString Action, FString MatchGroup, FString MatchShortCode, int32 Skill,  UGameSparksScriptData* ScriptData, bool Durable, int32 RequestTimeoutSeconds)
{
...
UGSMatchmakingRequest::UGSMatchmakingRequest(const class FObjectInitializer& PCIP) : Super(PCIP) {
}
...
UGSPSNConnectRequest* UGSPSNConnectRequest::SendPSNConnectRequest(FString AuthorizationCode, bool DoNotLinkToCurrentPlayer, bool ErrorOnSwitch, FString RedirectUri, UGameSparksScriptData* Segments, bool SwitchIfPossible, bool SyncDisplayName,  UGameSparksScriptData* ScriptData, bool Durable, int32 RequestTimeoutSeconds)
{
...
UGSPSNConnectRequest::UGSPSNConnectRequest(const class FObjectInitializer& PCIP) : Super(PCIP) {
}
